...
},n,a?i:t,a,null)}})}),ft.fn.size=function(){return this.length},ft.fn.andSelf=ft.fn.addBack,"object"==typeof module&&module&&"object"==typeof module.exports?module.exports=ft:(e.jQuery=e.$=ft,"function"==typeof n&&n.amd&&n("jquery",[],function(){return ft}))}(window),function(){n("placeholder",["jquery"],function(){var e,t,n;return n=function(){var e;return e=document.createElement("input"),"placeholder"in e},$.support.placeholder=n(),t=function(){return parseInt(1e8*Math.random())},$.fn.extend({placeholder:function(){var e,n,r,i,o;return n=$(this),o=n.attr("placeholder"),r=$('<div class="sui-placeholder-wrap"></div>'),n.replaceWith(r),n.appendTo(r),e=$("<label class='sui-placeholder'>"+o+"</label>"),r.append(e),i=n.attr("id"),i||(i="sui-placeholder-id-"+t(),n.attr("id",i)),e.attr("for",i),e.css({top:(r.height()-e.height())/2}),n.focus(function(){return e.hide()}),n.blur(function(){return e.show()})}}),$.support.placeholder?void 0:(e=$("[placeholder]"),e.each(function(){return $(this).placeholder()}))})}.call(this),function(){t(["placeholder"])}.call(this),n("entry",function(){}),t(["entry"])}();